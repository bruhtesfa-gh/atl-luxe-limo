...
const Contact = () => {
  ...
  const messageHandler = (e: any) => {
    ...
    axios
      .post("https://atl-luxe-limo-server.onrender.com/mail", {
        name,
        email,
        phone,
        message,
                      ...
                      <div className="elementor-widget-wrap elementor-element-populated">
                        ...
                        >
                          <div className="elementor-widget-container">
                            ...
                            />
                            <p>
                              Our office is open Monday through Friday from 9am
                              to 5pm. You can reach us by phone at 206-555-1234
                              or toll free at 1-800-555-1234. For after hours
                              inquiries, please leave us a message and we will
                              get back to you promptly the next business day.
                            </p>
                            <p>
                              You can also email us 24/7 at
                              info@atlluxelimo.com. We try to respond to all
                              inquiries within 24 hours. Our physical office is
                              located at 123 Main St, Seattle, WA 98102. Feel
